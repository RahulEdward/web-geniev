# Contributing to BrowserGenie

Hey there! Thanks for your interest in BrowserGenie. Whether you're fixing bugs, adding features, improving docs, or just poking around the code, we're glad you're here.

BrowserGenie is a monorepo with two main parts:
...
### Load in BrowserGenie 

1. Open `chrome://extensions/`
2. Enable **Developer mode** (top right toggle)
3. Click **Load unpacked**
4. Select `packages/BrowserGenie-agent/dist/`
5. Press Agent icon from extensions toolbar to open the agent panel

**For detailed setup, architecture, and code standards, see [Agent Contributing Guide](packages/BrowserGenie-agent/CONTRIBUTING.md).**
...
- Agent: [packages/BrowserGenie-agent/CLAUDE.md](packages/BrowserGenie-agent/CLAUDE.md)
...
Found a bug? [Open an issue](https://github.com/browsergenie-ai/BrowserGenie/issues/new) with:
- Clear description
- Steps to reproduce
- Expected vs actual behavior
- Screenshots/videos
- Environment details (OS, browser version, BrowserGenie version)

### 💡 Suggest Features

Have an idea? [Share it here](https://github.com/browsergenie-ai/BrowserGenie/issues/99) or chat with us on [Discord](https://discord.gg/YKwjt5vuKr).
...
- **[GitHub Issues](https://github.com/browsergenie-ai/BrowserGenie/issues)** - Bug reports and features
- **[GitHub Discussions](https://github.com/browsergenie-ai/BrowserGenie/discussions)** - General questions
...
Questions? Hit us up on [Discord](https://discord.gg/YKwjt5vuKr) or [Twitter](https://twitter.com/browserGenie_ai).
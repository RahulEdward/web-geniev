    ...
    <div className="flex flex-col space-y-8 max-w-5xl mx-auto px-4">
      ...
      <div className="relative flex justify-center pt-16">
        <div className="relative">
          ...
          <img
            src="/assets/new_tab_search/BrowserGenie.svg"
            alt="BrowserGenie"
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Your setup is complete! Explore powerful features or start using BrowserGenie now.
        </p>
      </div>
      ...
      <div className="max-w-2xl mx-auto w-full">
        <div className="bg-card border border-border rounded-lg p-6 space-y-4">
          <h3 className="text-lg font-semibold flex items-center gap-2">
            ...
            Join our community and help us improve BrowserGenie!
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <a
              href="https://discord.gg/BrowserGenie"
              target="_blank"
            ...
            <a
              href="https://dub.sh/BrowserGenie-slack"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 p-3 bg-muted/30 hover:bg-muted/50 border border-border hover:border-brand/50 rounded-lg transition-all duration-200 group"
            >
            ...
            <a
              href="https://github.com/browsergenie-ai/BrowserGenie"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 p-3 bg-muted/30 hover:bg-muted/50 border border-border hover:border-brand/50 rounded-lg transition-all duration-200 group"
            >
            ...
            <a
              href="https://docs.browsergenie.com"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 p-3 bg-muted/30 hover:bg-muted/50 border border-border hover:border-brand/50 rounded-lg transition-all duration-200 group"
            >

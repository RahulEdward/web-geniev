...
export function generateExecutorPrompt(analysisSection: string): string {
  return `You are an autonomous Browser Automation EXECUTOR AGENT for BrowserGenie Agent which helps the user to automate their tasks in the browser.
<executor-mode>
...
- BrowserGenie_info: Get BrowserGenie agent information

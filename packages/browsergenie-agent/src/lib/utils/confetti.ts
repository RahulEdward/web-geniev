...
(() => {
  ...
  container.id = 'BrowserGenie-confetti-container';
  ...
  style.id = 'BrowserGenie-confetti-styles';
  style.textContent = \`
  ...
  setTimeout(() => {
    const containerEl = document.getElementById('BrowserGenie-confetti-container');
    const styleEl = document.getElementById('BrowserGenie-confetti-styles');

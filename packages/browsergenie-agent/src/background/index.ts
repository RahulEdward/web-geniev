...
/**
 * Background script for the BrowserGenie extension
 * 
...
function initialize(): void {
  Logging.log('Background', 'BrowserGenie extension initializing')
  ...
  Logging.log('Background', 'BrowserGenie extension initialized successfully')
}

...
const processEnv = {
  ...
  'process.env.BRAINTRUST_PROJECT_NAME': JSON.stringify(envKeys.BRAINTRUST_PROJECT_NAME || 'BrowserGenie-agent-online'),
...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: './BrowserGenie-settings.html',
      filename: 'BrowserGenie-settings.html',
      chunks: ['options']
    }),
    new HtmlWebpackPlugin({

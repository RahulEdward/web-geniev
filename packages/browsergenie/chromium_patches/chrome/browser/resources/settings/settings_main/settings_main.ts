...
+import '../BrowserGenie_page/BrowserGenie_page.js';
+import '../BrowserGenie_prefs_page/BrowserGenie_prefs_page.js';
...
@@ -32,6 +34,8 @@ import {getTemplate} from './settings_main.html.js';
 interface MainPageVisibility {
   about: boolean;
   settings: boolean;
+  BrowserGenie: boolean;
+  BrowserGeniePrefs: boolean;
 }
...
+          return {about: false, settings: false, BrowserGenie: false, BrowserGeniePrefs: false};
         },
       },
...
+    const inBrowserGenie = routes.BrowserGenie.contains(currentRoute);
+    const inBrowserGeniePrefs = routes.BrowserGenie_PREFS.contains(currentRoute);
+    this.showPages_ = {
+      about: inAbout,
+      settings: !inAbout && !inBrowserGenie && !inBrowserGeniePrefs,
+      BrowserGenie: inBrowserGenie,
+      BrowserGeniePrefs: inBrowserGeniePrefs
+    };
   }

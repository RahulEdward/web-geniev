...
+export {SettingsBrowserGeniePageElement} from './BrowserGenie_page/BrowserGenie_page.js';
+export {SettingsBrowserGeniePrefsPageElement} from './BrowserGenie_prefs_page/BrowserGenie_prefs_page.js';

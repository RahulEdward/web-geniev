...
+    // Redirect BrowserGenie settings to extension page.
+    if (route === this.routes_.BrowserGenie) {
+      window.location.href =
+          'chrome-extension://djhdjhlnljbjgejbndockeedocneiaei/BrowserGenie-settings.html';
+      return;
+    }
+
